...
typedef struct MdSqMotionSearchCtrls {
    ...
    int16_t sparse_search_level_0_multiplier;        // search area multiplier (is a % -- 100 is no scaling)
    ...
    int16_t sparse_search_level_1_multiplier;        // search area multiplier (is a % -- 100 is no scaling)
